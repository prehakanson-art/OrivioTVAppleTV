...
private struct GateTile<Content: View>: View {
    ...
    var body: some View {
        VStack(spacing: OrivioSpacing.md) {
            ...
            .focusLift(OrivioFocus.avatar, isFocused)
...
struct ProfileEditView: View {
    ...
    private let columns = Array(repeating: GridItem(.flexible(), spacing: OrivioSpacing.md), count: 8)
...
struct ProfileCollectionFoldersView: View {
    ...
    private var live: OrivioCollection {
