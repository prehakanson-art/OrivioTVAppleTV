...
final class TraktStore: ObservableObject {
    ...
    private static let tokenKey = "orivio.trakt.tokens.v1"
    private static let userKey = "orivio.trakt.user.v1"
    private static let perProfileKey = "orivio.trakt.perProfileAccounts.v1"
    private static let explicitLoginKey = "orivio.trakt.signedInHere.v1"
    ...
    private static let scrobbleKey = "orivio.trakt.scrobble.v1"
    private static let secretKey = "orivio.trakt.secret.v1"
    private static let histKey = "orivio.trakt.synchistory.v1"
    private static let playbackKey = "orivio.trakt.syncplayback.v1"
    private static let watchlistKey = "orivio.trakt.syncwatchlist.v1"
    private static let ratingsKey = "orivio.trakt.syncratings.v1"
