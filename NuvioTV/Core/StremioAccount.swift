...
enum StremioSync {
    ...
    static func pushCombined(authKey: String,
        ...
        do {
            ...
            NuvioSyncDiagnostics.record(.warning, area: "Stremio", "Add-on push to Stremio failed: \(error.localizedDescription)")
        }
        ...
        do {
            ...
            NuvioSyncDiagnostics.record(.warning, area: "Stremio", "Library push to Stremio failed: \(error.localizedDescription)")
        }
